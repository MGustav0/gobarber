...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /** Checar se "provider_id" é um provedor */
    ...
    /** Checagem se o usuário está marcando com ele mesmo e impedir. */
  ...
  async delete(req, res) {
    ...
    /** Impedir que delete o agendamento com menos de 2hs de agendamento. */
